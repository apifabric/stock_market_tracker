...
@Component({
  selector: 'MarketIndex-home',
  templateUrl: './MarketIndex-home.component.html',
  styleUrls: ['./MarketIndex-home.component.scss']
})
export class MarketIndexHomeComponent implements AfterViewInit {
