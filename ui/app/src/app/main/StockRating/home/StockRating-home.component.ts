...
@Component({
  selector: 'StockRating-home',
  templateUrl: './StockRating-home.component.html',
  styleUrls: ['./StockRating-home.component.scss']
})
export class StockRatingHomeComponent implements AfterViewInit {
