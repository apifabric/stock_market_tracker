...
@Component({
  selector: 'IndexStock-home',
  templateUrl: './IndexStock-home.component.html',
  styleUrls: ['./IndexStock-home.component.scss']
})
export class IndexStockHomeComponent implements AfterViewInit {
