...
@Component({
  selector: 'NewsArticle-home',
  templateUrl: './NewsArticle-home.component.html',
  styleUrls: ['./NewsArticle-home.component.scss']
})
export class NewsArticleHomeComponent implements AfterViewInit {
